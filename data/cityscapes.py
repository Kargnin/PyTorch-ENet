...
class Cityscapes(data.Dataset):
    ...
    train_folder = "/content/leftImg8bit/train"
    train_lbl_folder = "/content/gtFine/train"

    # Validation dataset root folders
    val_folder = "/content/leftImg8bit/val"
    val_lbl_folder = "/content/gtFine/val"

    # Test dataset root folders
    test_folder = "/content/leftImg8bit/test"
    test_lbl_folder = "/content/gtFine/test"
